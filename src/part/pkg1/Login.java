...
public class Login extends javax.swing.JFrame {
   ...
   public Login(Registration registration) {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        boolean isVaild = setCredentials(Username,Password);
        
       String loginStatus = returnLoginStatus(isVaild);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new Login(registration).setVisible(true);
            }
        });
    }
    ...
    private static class registration extends Registration {
